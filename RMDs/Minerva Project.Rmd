...
reactable(q6sentiment_comments_tab, wrap = TRUE, theme = fivethirtyeight(), striped = TRUE, fullWidth = TRUE, resizable = TRUE)
...
While this sentiment analysis tool is generally reliable, there are times when it will not gauge accurately the overall sentiment of the response. For example in question 4, one student responded, "better communication with the professor, and not feeling scared to answer even if I'm confident with my answer." The response is discussing things to improve, and therefore slightly negative, but the sentiment score is positive. There, while this is an interesting tool, taking the time to look at individual responses might be more worthwhile. 
